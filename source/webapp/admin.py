...
class TaskAdmin(admin.ModelAdmin):
    list_display = ['id', 'name', 'description', 'status', 'created_at', 'updated_at', 'project']
    list_display_links = ['name']
    list_filter = ['status']
    search_fields = ['name', 'description']
    fields = ['name', 'description', 'status', 'type', 'created_at', 'updated_at', 'project']
...
class ProjectAdmin(admin.ModelAdmin):
    ...
    list_filter = ['name']
    search_fields = ['name']
    fields = ['name', 'date_started', 'date_finished']
